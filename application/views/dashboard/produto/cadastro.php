  ...
  <div style="margin: 0 16px">
    <form method="POST" action="" id="<?=$idFormulario?>">
      ...
      <div class="w3-padding" style="margin:0 -16px">
        <div>
          <a class="w3-button w3-red" href="<?=base_url('admin/produtor')?>"><i class="fa fa-chevron-left"></i> Voltar</a>
        ...
        <div class="w3-responsive w3-card w3-white w3-padding-32">
          <div class="w3-row-padding">
            <div class="w3-col <?=$coluna?> w3-margin-top">
              ...
              <select class="w3-select w3-white w3-border" id="categoria_produto" name="categoria_produto">
            ...
            <div class="w3-col <?=$coluna?> w3-margin-top">
              ...
              <select class="w3-select w3-white w3-border" id="gerar-referencia" name="gerar-referencia" onchange="toogleGerarReferencia()">
                <option value="0">Sim</option>
                <option value="1">Referência manual</option>
              </select>
            </div>
            <?php endif;?>
            <div class="w3-col <?=$coluna?> w3-margin-top">

...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <header class="w3-container w3-cell-row" style="padding-top:22px">
        ...
        <button onclick="window.location.href='<?= base_url("admin/produto/cadastro") ?>'"
                class="w3-button w3-round w3-red w3-right"><i class="fa fa-plus"></i> Cadastrar
        </button>
        <button class="w3-button w3-red w3-right" style="margin-right: 12px" onclick="limparSearch(1)">Limpar Filtros
        </button>
    </header>
    <div class="w3-panel">
            ...
            <div class="w3-container w3-card w3-white w3-padding w3-padding-32">
                <div class="w3-row-padding w3-center">
                    <div class="w3-col l2">
                        ...
                        <input type="text" class="w3-input w3-border" placeholder="Referencia do Produto"
                               id="referenciasearch">
                    </div>
                    <div class="w3-col l3">
                    ...
                    <div class="w3-col l2">
                        ...
                        <select class="w3-select w3-border w3-white" id="ingredientesearch">
                    ...
                    <div class="w3-col l2">
                        ...
                        <button class="w3-button w3-block w3-red" onclick="getProdutos(1)"><i class="fa fa-search"></i>
                        </button>
                    </div>
                </div>
            </div>
